...
static const char *OpenCLKernels =
  ...
  "}\n"
  "\n"
  "__kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) kRestrict6(int const nelem_x_elemsize_x_ncomp, __global double const *__restrict__ uu, __global double *__restrict__ vv)\n"
  "{\n"
  "  for (int i = 0; i <= -1 + nelem_x_elemsize_x_ncomp; ++i)\n"
  "    vv[i] = uu[i];\n"
  "}\n"
  "\n"
  ...
  "}\n"
  "__kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) massf(__global int const *__restrict__ ctx, int const Q, __global int const *__restrict__ iOf7, __global int const *__restrict__ oOf7, __global double const *__restrict__ in, __global double *__restrict__ out)\n"
  "{\n"
  "  int dummy;\n"
  "\n"
  "  dummy = ctx[0];\n"
  ...
  "\n"
  "#define Sqr(a) ((a)*(a))\n"
  "__kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) masssetupf(__global int const *__restrict__ ctx, int const Q, __global int const *__restrict__ iOf7, __global int const *__restrict__ oOf7, __global double const *__restrict__ in, __global double *__restrict__ out)\n"
  "{\n"
  "for (int i=0; i<Q; i++) {\n"
  "  const int D = 3;\n"
  "  double det = (+ in[iOf7[1]+(0*D+0)*Q+i] *"
  ...
  "}\n"
  "\n"
  "__kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) masssetupfour(__global int const *__restrict__ ctx, int const Q, __global int const *__restrict__ iOf7, __global int const *__restrict__ oOf7, __global double const *__restrict__ in, __global double *__restrict__ out)\n"
  "{\n"
  "  double acc_d;\n"
  "  double acc_d_0;\n"
  "  double det;\n"
  ...
  "    for (int d = 0; d <= 2; ++d)\n"
  "    {\n"
  "      val = in[d * Q + i + iOf7[0]] * in[d * Q + i + iOf7[0]];\n"
  "      index0 = offset + d * Q;\n"
  "      f = ((d + 2) % 3);\n"
  "      index4 = offset + (3 + f) * Q;\n"
  "      index2 = offset + (6 + f) * Q;\n"
  ...
  "      index3 = offset + (6 + e) * Q;\n"
  "      index1 = offset + (3 + e) * Q;\n"
  "      detv = pow(-1.0, d) * in[index0] * (in[index1] * in[index2] + -1.0 * in[index3] * in[index4]);\n"
  "      acc_d_0 = acc_d_0 + detv;\n"
  "    }\n"
  "    det = acc_d_0;\n"
