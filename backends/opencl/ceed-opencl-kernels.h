...
static const char *OpenCLKernels =
  ...
  "        }\n"
  "}\n"
  " __kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) setup(int const Q, int const iOf7_0, __global double const *__restrict__ in, int const oOf7_0, __global double *__restrict__ out)"
  "{\n"
  "    for (int i = 0; i <= -1 + Q; ++i)\n"
  "          out[oOf7_0 + i] = in[iOf7_0 + i];\n"
  "}\n"
  "__kernel void __attribute__ ((reqd_work_group_size(1, 1, 1))) mass(int const Q, int const iOf7_0, int const iOf7_1, __global double const *__restrict__ in, int const oOf7_0, __global double *__restrict__ out)\n"
  "{\n"
  "    int index0;\n"
  "    int index1;\n"
  "\n"
